...
class DiffusionPipeline:
    ...
    def generate_image(self, text_prompt: str, output_path: str, cfg: bool = False, s: int = 7):
        """
        ...
        for step in tqdm(range(self.num_timesteps, 0, -1)):
            ...
            if cfg:
                ...
                unc_cond_prediction = self.model(img_stack, t_stack, c_stack, mask_stack)
    ...
    def __call__(self, text_prompt: str, output_path: str, cfg: bool = False, s: int = 7):
